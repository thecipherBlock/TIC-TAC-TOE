...
(function(exports) {
  ...
  var Printing = (function () {
      function Printing(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Printing.create = function (value0) {
          return function (value1) {
              return new Printing(value0, value1);
          };
      };
      return Printing;
  })();
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.table_([ Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Printing.create("a"))) ])([ Halogen_HTML_Core.text(state.a) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("vert"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Printing.create("b"))) ])([ Halogen_HTML_Core.text(state.b) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Printing.create("c"))) ])([ Halogen_HTML_Core.text(state.c) ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("hori"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Printing.create("d"))) ])([ Halogen_HTML_Core.text(state.d) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("verthori"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Printing.create("e"))) ])([ Halogen_HTML_Core.text(state.e) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("hori"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Printing.create("f"))) ])([ Halogen_HTML_Core.text(state.f) ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Printing.create("g"))) ])([ Halogen_HTML_Core.text(state.g) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("vert"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Printing.create("h"))) ])([ Halogen_HTML_Core.text(state.h) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Printing.create("i"))) ])([ Halogen_HTML_Core.text(state.i) ]) ]) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(state.w) ]), Halogen_HTML_Elements.p([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Restart.create)) ])([ Halogen_HTML_Core.text("RESTART") ]) ]);
  };
  var initialState = {
      a: "",
      b: "",
  ...
  var rowCheck = function (dictApplicative) {
      return function (arr) {
          var v = FFI_Util.property(turnXO)("0");
          var v1 = (function () {
              var $19 = arr.a === arr.b && (arr.b === arr.c && arr.a !== "");
              if ($19) {
                  return FFI_Util.setProperty(winner)("0")(arr.a + " Won the game");
              };
              var $20 = arr.d === arr.e && (arr.e === arr.f && arr.d !== "");
              if ($20) {
                  return FFI_Util.setProperty(winner)("0")(arr.d + " Won the game");
              };
              var $21 = arr.g === arr.h && (arr.h === arr.i && arr.g !== "");
              if ($21) {
                  return FFI_Util.setProperty(winner)("0")(arr.g + " Won the game");
              };
              var $22 = arr.a === arr.d && (arr.d === arr.g && arr.a !== "");
              if ($22) {
                  return FFI_Util.setProperty(winner)("0")(arr.a + " Won the game");
              };
              var $23 = arr.b === arr.e && (arr.e === arr.h && arr.b !== "");
              if ($23) {
                  return FFI_Util.setProperty(winner)("0")(arr.b + " Won the game");
              };
              var $24 = arr.c === arr.f && (arr.f === arr.i && arr.c !== "");
              if ($24) {
                  return FFI_Util.setProperty(winner)("0")(arr.c + " Won the game");
              };
              var $25 = arr.a === arr.e && (arr.e === arr.i && arr.a !== "");
              if ($25) {
                  return FFI_Util.setProperty(winner)("0")(arr.a + " Won the game");
              };
              var $26 = arr.c === arr.e && (arr.e === arr.g && arr.c !== "");
              if ($26) {
                  return FFI_Util.setProperty(winner)("0")(arr.c + " Won the game");
              };
              return FFI_Util.setProperty(winner)("0")("");
          })();
          return Control_Applicative.pure(dictApplicative)(initialState);
      };
  };
  var count = [ 0 ];
  var drawCon = function (dictApplicative) {
      return function (arr) {
          var v = FFI_Util.property(count)("0");
          var v1 = (function () {
              var $28 = v === 9;
              if ($28) {
                  return FFI_Util.setProperty(winner)("0")("Match Drawn");
              };
              return FFI_Util.setProperty(winner)("0")(FFI_Util.property(winner)("0"));
          })();
          return Control_Applicative.pure(dictApplicative)(initialState);
      };
  };
  var update = function (dictApplicative) {
      return function (arr) {
          return function (ren) {
              var v = FFI_Util.property(count)("0");
              var v1 = (function () {
                  var $30 = Data_Int.even(v);
                  if ($30) {
                      return FFI_Util.setProperty(turnXO)("0")("X");
                  };
                  return FFI_Util.setProperty(turnXO)("0")("O");
              })();
              var v2 = (function () {
                  var $31 = FFI_Util.property(winner)("0") === "" && FFI_Util.property(arr)(ren) === "";
                  if ($31) {
                      return FFI_Util.setProperty(count)("0")(v + 1 | 0);
                  };
                  return FFI_Util.setProperty(arr)(ren)(FFI_Util.property(arr)(ren));
              })();
              var v3 = (function () {
                  var $32 = FFI_Util.property(winner)("0") === "" && FFI_Util.property(arr)(ren) === "";
                  if ($32) {
                      return FFI_Util.setProperty(arr)(ren)(FFI_Util.property(turnXO)("0"));
                  };
                  return FFI_Util.setProperty(arr)(ren)(FFI_Util.property(arr)(ren));
              })();
              return Control_Applicative.pure(dictApplicative)(initialState);
  ...
  var $$eval = function (v) {
      if (v instanceof Printing) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(update(Halogen_Query_HalogenM.applicativeHalogenM)(v1)(v.value0))(function (v2) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(rowCheck(Halogen_Query_HalogenM.applicativeHalogenM)(v1))(function (v3) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(drawCon(Halogen_Query_HalogenM.applicativeHalogenM)(v1))(function (v4) {
      ...
      if (v instanceof Restart) {
          var v1 = FFI_Util.setProperty(count)("0")(0);
          var v2 = FFI_Util.setProperty(winner)("0")("");
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
              return {
                  a: "",
                  b: "",
      ...
      throw new Error("Failed pattern match at Component line 161, column 8 - line 173, column 16: " + [ v.constructor.name ]);
  };
  ...
  exports["drawCon"] = drawCon;
  exports["turnXO"] = turnXO;
